...
@Autonomous(name = "far Red 15 flush + spike w/ leave", group = "far")
public class farRedflushAndSpike extends LinearOpMode {
    ...
    public class Robot {
        ...
        public Action turret1f() { return new turret1f(); }
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Action TEST = drive.actionBuilder(initialPose)
                ...
                .splineToLinearHeading( new Pose2d(35, 30, Math.toRadians(90)), Math.toRadians(-180)/*,adaptiveBrake*/)

                .setTangent(Math.toRadians(-270))
                .splineToSplineHeading(new Pose2d(35, 60, Math.toRadians(90)), Math.toRadians(-270), adaptiveBrake)
                ...
                .setTangent(Math.toRadians(270))
                .splineToSplineHeading(shotPose, Math.toRadians(270)/*,adaptiveBrake*/)
                //.waitSeconds(1)
                ...
                .setTangent(Math.toRadians(180))
                .splineToSplineHeading(new Pose2d(40, 30, Math.toRadians(90)), Math.toRadians(180), adaptiveBrake)

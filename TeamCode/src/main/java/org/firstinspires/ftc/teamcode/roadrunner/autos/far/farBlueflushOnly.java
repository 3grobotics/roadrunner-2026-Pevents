...
@Autonomous(name = "far blue 18 only flushes without leave", group = "far")
public class farBlueflushOnly extends LinearOpMode {
    ...
    public class Robot {
        ...
        private MecanumDrive2 driver;

        public Robot(MecanumDrive2 driver) {
            this.driver = driver;
        }
